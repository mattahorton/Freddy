...
class JSONSubscriptingTests: XCTestCase {
    ...
    func testThatUnexpectedSubscriptIsThrown() {
        do {
            ...
            XCTAssert(type == String.self, "The dictionary at index 1 should not be subscriptable by: \(type).")
        } catch {
    ...
    func testJSONErrorTypeNotConvertible() {
        do {
            ...
            XCTAssert(to == Int.self, "The error should be due the value not being an `Int` case, but was \(to).")
    ...
    func testJSONErrorUnexpectedSubscript() {
        do {
            ...
            XCTAssert(type == String.self, "The error should be due the value not being subscriptable with string `String` case, but was \(type).")
        } catch {
